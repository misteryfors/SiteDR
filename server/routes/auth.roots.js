...
router.post('/registration',
    ...
    try {
        ...
        const sUser = await User.findOne({_id:'642afd5a8044c009919166e0'})
        const chat = new Chat({firstUser:newUser.id,secondUser:'642afd5a8044c009919166e0',firstUserName:fUser.name,secondUserName:sUser.name,messages:[],notice:'Поздравляем вы зарегестрированны'})
        await chat.save()
